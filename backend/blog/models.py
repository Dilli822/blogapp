...
class BlogDetails(models.Model):
    ...
    def save(self, *args, **kwargs):
       ...
       if not self.slug:
        ...
        # Save the username if the user field is not None and is a ForeignKey
        if self.user_id and isinstance(self.user, models.ForeignKey):
            self.username = self.user.username
        
        super().save(*args, **kwargs)  # Call super method to save